...
declare global {
  ...
  const accessMenuData: typeof import('../src/stores/user')['accessMenuData']
  ...
  const useLayoutStore: typeof import('../src/stores/layout-menu')['useLayoutStore']
  ...
  const useScrollTo: typeof import('../src/composables/useScrollTo')['useScrollTo']
  ...
  const useThemeConfig: typeof import('../src/hooks/setting/useThemeConfig')['useThemeConfig']
